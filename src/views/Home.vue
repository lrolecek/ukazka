<template>
  <div class="home">
    ...
    <p>Small batch humblebrag bicycle rights tousled neutra woke fashion axe distillery polaroid tilde irony occupy butcher squid whatever. Viral banh mi four loko, pour-over leggings taxidermy mumblecore messenger bag migas hell of distillery bitters hoodie. Poutine tattooed chillwave vaporware, pitchfork hoodie plaid post-ironic. Gastropub distillery man braid blue bottle, try-hard slow-carb pabst pop-up cornhole. Put a bird on it edison bulb bespoke, food truck twee la croix wayfarers keytar craft beer.</p>
  </div>
</template>
